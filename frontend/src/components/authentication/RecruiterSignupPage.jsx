/**
 * Recruiter Signup Page Component.
 * This component provides a signup form for recruiters.
 ...
 * Handles form submission and communicates with the authentication provider to register recruiters.
 * Displays error message, loading indicator, and link for login.
 * @module RecruiterSignupPage
...
import { recruiterSignupProvider } from "../../services/api/authService";
...
function RecruiterSignupPage() {
  ...
  const { recruiterSignupProvider } = useAuth();
